...
export const BuildingAmenitiesFilterDesktop = (props: BaseFilterProps) => {
  return <BuildingAmenitiesFilter {...props} options={BUILDING_AMENITIES_OPTIONS} variant="compact" />;
};
