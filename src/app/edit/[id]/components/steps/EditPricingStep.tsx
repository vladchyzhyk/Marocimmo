...
type Props = {
  onDataChange?: (values: EditPricingStepValues) => void;
  onBack?: () => void;
  initialValues?: Partial<EditPricingStepValues>;
};

const EditPricingStep = ({ onDataChange, initialValues }: Props) => {
  ...
  return (
    <div className="flex flex-col gap-12 md:gap-8 lg:gap-12 xl:gap-12 w-full min-h-screen md:min-h-fit pb-25 scrollbar-none px-4 md:px-4 lg:px-6 xl:px-0">
      ...
      {/* Special Conditions */}
      <div className="flex flex-col gap-6 md:gap-4 lg:gap-6 xl:gap-6 w-full">
        <div className="flex flex-col gap-1">
...
export default EditPricingStep;
